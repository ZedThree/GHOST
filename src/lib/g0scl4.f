      SUBROUTINE G0SCL4(SURFAS,ISTRTX,ISTOPX,NPTSX,
     &                  ISTRTY,ISTOPY,NPTSY)
C
C          ------------------------------------------------
C          ROUTINE NO. ( 355)   VERSION (A9.1)    13:JAN:94
C          ------------------------------------------------
C
      PARAMETER (ISZARR= 1200, JSZARR= 600)
      REAL    SURFAS(NPTSX,NPTSY),XPOS(JSZARR),YPOS(JSZARR),
     &        RDATA(1),XADDPT(3),YADDPT(3)
...
C          CASE 3
C
            CALL G0SMAT(XPOS,YPOS,INDST,IND-1,
     &                  XADDPT,YADDPT,INDADD,MATINX,MATINY)
            INDADD= 0
...
C          CASE 2
C
            CALL G0SMAT(XPOS,YPOS,INDST,IND,
     &                  XADDPT,YADDPT,INDADD,MATINX,MATINY)
            INDADD= 0
          ENDIF
C
