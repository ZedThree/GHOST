...
C
C          ------------------------------------------------
C          ROUTINE NO. (1002)   VERSION (A8.1AP)  14:JUL:97
C          ------------------------------------------------
C
...
C
     ...
     &        IPL5(42),IPL6(49),IPL7(62),IPL8(51),IPL9(48),IPLA(51),
     &        IPLB(57),IPLC(54),IPLD(59),IPLE(47),IPLF(50),IPLG(49),
     &        IPLH(55),IPLI(71),IPLJ(43),IPLK(70),IPLL(61),IPLM(58),
     &        IPLN(30),IPLO(12)
      LOGICAL KHRDW1,LHRDW1,CURTRA
C
      COMMON /T1APBB/ CHIGHT,ZOBLAT,IGREYS(255),IPAGE(17),IPGCNT,
     &                IPBBOX(26),IDBOX(14),IPBOX(18)
...
C   IPL6  /gs {gsave} bd /gr {grestore} bd /G {setgray} bd
...
C   IPLB  /i {0 G 1 setlinecap 1 setlinejoin 0.24 0.24 scale 75 75
...
C
     ...
     &           116,111,114,101,125, 32, 98,100, 32, 47, 71, 32,
     &           123,115,101,116,103,114, 97,121,125, 32, 98,100,
     &            32/
     ...
     &            98,100,32/
      DATA IPLB / 47,105, 32,123, 48, 32, 71, 32, 49, 32,115,101,
     &           116,108,105,110,101, 99, 97,112, 32, 49, 32,115,
     &           101,116,108,105,110,101,106,111,105,110, 32, 48,
     &            46, 50, 52, 32, 48, 46, 50, 52, 32,115, 99, 97,
     &           108,101, 32, 55, 53, 32, 55, 53, 32/
...
C
      IGREYS(NCOLS1)= NINT(REDCO1(NCOLS1)*30.0+GRNCO1(NCOLS1)*59.0+
     &                     BLUCO1(NCOLS1)*11.0)
      IF (NCOLS1.NE.KOLLID) RETURN
C
      CALL G1FILB(0,0,-17,KOLLID)
      CALL G1FILB(0,0,-84,0)
      RETURN
C
